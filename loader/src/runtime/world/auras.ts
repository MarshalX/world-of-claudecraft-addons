...
} from '../../shared/aura-kinds.generated.ts';
...
function isToggle(aura: Pick<Aura, 'id' | 'kind'>): boolean {
  ...
  return TOGGLE_AURA_KINDS.has(aura.kind) || TOGGLE_AURA_IDS.has(aura.id);
}
...
export { filterAuras, filterPartyAuras, isDispellable, isHarmful, isToggle, NO_ROWS, NONE };
